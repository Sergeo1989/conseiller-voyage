...
- [X] T059 Quality gates : `pnpm check:boundaries` + `pnpm lint` + `pnpm typecheck` (17 packages) + matrice quickstart (13 scénarios) verts.
...
- [X] T060 Mettre à jour `docs/roadmap.md` (012 ⏳ → 🟡) + cocher DoD `plan.md` + ouvrir PR vers `main` (Constitution Check verbatim + ADRs 0025-0026).
