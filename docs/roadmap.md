...
| 011 | Matching — scoring conseiller × brief (pur, TDD obligatoire) | matching | M | 🟡 livré branche `008-matching-scoring` (US1-US3 + polish, PR à ouvrir) | 001, 008. 3 US + Phase 6 polish (métriques OTel, dashboard, runbooks, ADRs 0020-0024 acceptés, CLI anti-PII). Avant merge prod : régénérer `fsa-centroids.json` complet (1 622 FSA, actuellement bootstrap 41) ; T093 (drain `matching_outbox`→bus) en PR satellite Mode B (ADR-0024 §E3). |
