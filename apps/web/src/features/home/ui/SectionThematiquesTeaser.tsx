        ...
        {items.map((item) => (
          <li key={item}>
            <Link
              ...
              className="inline-flex rounded-full border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-blue-700 hover:text-blue-700"
            >
              {item}
            </Link>
          </li>
